...
const Footer = () => {
  return (
    <div className='flex flex-col md:flex-row justify-between items-center w-full h-[110px] sm:h-[80px] lg:h-[80px] xl:h-[80px] font-text bg-dark-gray dark:bg-primary/20 backdrop-blur-md fixed bottom-0 left-0 px-14 pt-2 sm:pt-0 xl:pt-0 pb-6 sm:pb-0 xl:pb-0'>
