...
const BoxtextResume = ({title, description, size="text-[12px] sm:text-[18px]"}) => {
  return (
    <div className={`rounded-lg py-8 px-6 mb-4 w-90 sm:w-164 lg:w-180 xl:w-190 border-l-12 border-sky-blue dark:border-blue-iris bg-white/65 dark:bg-dark-gray/85`}>
