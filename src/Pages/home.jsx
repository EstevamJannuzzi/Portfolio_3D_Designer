        ...
        <DefaultScreen className='z-30'>
            ...
            <div className="relative flex flex-col items-center justify-center gap-6 mt-16 mb-8 ml-0 sm:ml-14 lg:ml-26 xl:ml-14">
                <BoxText
                    ...
                    width="max-w-50 sm:max-w-60 lg:max-w-80 xl:max-w-90"
                    distance="z-20 relative"
                    margin="-mb-4 sm:-mb-20 lg:-mb-20 xl:-mb-24 mr-30 sm:mr-70 lg:mr-90 xl:mr-100"
                    size="text-[14px] sm:text-[18px] lg:text-[20px] xl:text-[22px]"
                />
                <img
                    src={Gremlin}
                    alt="Gremlin"
                    className="flex justify-center items-center w-[280px] sm:w-[500px] lg:w-[600px] xl:w-[900px] ml-22 sm:ml-0 lg:ml-0 xl:ml-30 -mt-50 z-10 relative"
                />
            </div>
            <div className='flex flex-col items-center justify-center gap-6 mb-4 mt-22'>
                ...
                <BoxText
                    ...
                    width="max-w-60 sm:max-w-80 lg:max-w-80 xl:max-w-90"
                    distance="z-20 relative"
                    margin="-mt-50 sm:-mt-80 lg:-mt-100 xl:-mt-126 ml-30 sm:ml-50 lg:ml-70 xl:ml-120"
                    size="text-[14px] sm:text-[18px] lg:text-[20px] xl:text-[22px]"
                />
            </div>
        </DefaultScreen>
